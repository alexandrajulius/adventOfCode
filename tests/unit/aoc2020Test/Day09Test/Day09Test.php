...
namespace Tests\unit\aoc2020Test\Day09Test;

use aoc2020\Day09\Day09;
use Generator;
...
final class Day09Test extends TestCase
{
     ...
     */
    public function testFindsContiguousSetOfSummands(string $input, int $range, int $expected): void
    {
        $actual = (new Day09())->findContiguousSetOfSummands($input, $range);
